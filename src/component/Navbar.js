...
const Navbar = () => {
  ...
  return (
    ...
    <div className='flex items-center gap-5'>
        ...
        <p className=' bg-black text-[15px] px-4 py-1 rounded-2xl  md:block cursor-pointer'>  Install App </p>
        <p className='bg-purple-500 text-black w-6 h-6 rounded-full  flex items-center justify-center'>D</p>
    </div>
