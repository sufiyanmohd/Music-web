...
<div className="flex items-center gap-3 pl-8 cursor-pointer">
 ...
 <div className='bg-[#121212] h-[85%] rounded'>
    ...
    <div className='p-4  bg-[#242424] m-2  rounded font-semibold flex flex-col items-start justify-start gap-2 pl-4 mt-4'>
        <h1>Lets findsome podcasts follow</h1>
        <p className='font-light'>we well keep update on new episode</p>
        <button className='px-4 py-1.5 bg-white text-[15px] text-black rounded-full mt-4'> Browns podcasts</button>
    </div>
 </div>
